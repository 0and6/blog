...
switch($parametros[$indice]):
    case "posts":
        ...
        $sentencia = 'SELECT posts.titulo, posts.fecha_pub, posts.contenido, autores.nombre as autor,'
                .' categorias.nombre as categoria, categorias.url as categoriaurl FROM posts inner join autores on posts.autor = autores.id '
    ...
    case "categoria":
        ...
        . " autores.nombre as autor, categorias.nombre as categoria, categorias.url as categoriaurl from posts inner join autores on posts.autor = "
    ...
    case $parametros[$indice] == "":
        $sentencia = "SELECT posts.titulo, posts.url, posts.fecha_pub, posts.descripcion,"
                . "autores.nombre as autor, categorias.nombre as categoria, categorias.url as categoriaurl FROM posts inner" .
